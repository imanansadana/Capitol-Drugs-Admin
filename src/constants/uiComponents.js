...
export const PRODUCTS = [
  ...
  {
    name: 'Sub Categories',
    path: '/app/products/sub-categories',
  },
  {
    name: 'Discount',
    path: '/app/products/discount',
  },
];
export const EXTRAUTILITIES = [
  {
    name: 'Smoothies',
    path: '/app/smoothies',
  },
  {
    name: 'Categories',
    path: '/app/smoothies/categories',
  },
  {
    name: 'Sub Categories',
    path: '/app/smoothies/sub-categories',
  },
];
export const ORDERS = [
  {
...
export const ACCOUNTS = [
  {
    name: 'Customers',
    path: '/app/accounts/customers',
  },
  {
    name: 'Sub Admin',
    path: '/app/accounts/sub-admin',
  },
];
export const STORE = [
  {
    name: 'Stores',
    path: '/app/store/stores',
  },
];
export const PAYMENTS = [
  ...
  {
    name: 'Purchase List',
    path: '/app/payment/purchase-list',
  },
];
