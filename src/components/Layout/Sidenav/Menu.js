  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <SubMenu
          key="/app/extra-utilities"
          title={
            <span>
              <Icon type="shopping-cart" />
              <span className="nav-text">Smoothies</span>
            </span>
          }
        >
          {this.getNavMenuItems(EXTRAUTILITIES)}
        </SubMenu>
